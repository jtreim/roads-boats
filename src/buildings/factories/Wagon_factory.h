#ifndef WAGON_FACTORY_H
#define WAGON_FACTORY_H
...
namespace building
{
class Wagon_factory : public Secondary_producer
{
public:
  Wagon_factory();
  Wagon_factory(const Wagon_factory &other);
  ~Wagon_factory();

  Wagon_factory operator=(const Wagon_factory &other);
