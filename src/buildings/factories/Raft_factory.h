#ifndef RAFT_FACTORY_H
#define RAFT_FACTORY_H
...
namespace building
{
class Raft_factory : public Secondary_producer
{
public:
  Raft_factory();
  Raft_factory(const Raft_factory &other);
  ~Raft_factory();

  Raft_factory operator=(const Raft_factory &other);
