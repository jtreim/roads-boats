#ifndef STONE_FACTORY_H
#define STONE_FACTORY_H
...
namespace building
{
class Stone_factory : public Secondary_producer
{
public:
  Stone_factory();
  Stone_factory(const Stone_factory &other);
  ~Stone_factory();

  Stone_factory operator=(const Stone_factory &other);
